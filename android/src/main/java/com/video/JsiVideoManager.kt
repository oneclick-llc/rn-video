...
class JsiVideoManager(private val context: ReactApplicationContext) {
  ...
  @DoNotStrip
  fun isPaused(channel: String, videoId: String): Boolean {
    return AppVideosManager.shared.isPaused(channel, videoId)
  }

  @DoNotStrip
  fun isMuted(channel: String, videoId: String): Boolean {
    return AppVideosManager.shared.isMuted(channel, videoId)
  }
